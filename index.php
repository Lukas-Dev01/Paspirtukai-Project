...
<body>
  ...
  <div class="fotke">
    ...
    <main>
        <div class="container">
       <br>
        <h2 class="antras">Siuo metu populiarus skelbimai</h2>
        <br>
            <br />
  	...
  	width: 50%;" src="img/skuteris.jpg<?php echo $row["image"]; ?>" class="img-responsive" />
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					<tr>
						<th width="40%">Daikto pavadinimas</th>
						<th width="10%">Vienetai</th>
